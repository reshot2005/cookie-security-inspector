...
Substitutes cookie-security-inspector, Cookie Security Inspector, and __ORG_NAME__ placeholders.
...
REPLACEMENTS_TEMPLATE = [
    ("cookie_security_inspector", "{slug_underscore}"),
    ("cookie-security-inspector", "{slug_kebab}"),
    ("Cookie Security Inspector", "{name}"),
    ("cookie-security-inspector", "{slug_kebab}"),
    ("Cookie Security Inspector", "{name}"),
    ("__ORG_NAME__", "{org}"),
]
