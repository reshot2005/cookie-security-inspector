...
- [ ] Benchmark recorded in `docs/benchmarks.md`
- [ ] CLI and every exposed interface tested
...
This template instance (`cookie-security-inspector`) satisfies the structural requirements but uses placeholder methodology content. It is **not** marked complete as a collection tool — it is a scaffold proof.
