...
cookie-security-inspector analyze sample_data/example.txt --json

# Generate HTML report
cookie-security-inspector analyze sample_data/example.txt --html report.html
```
...
cookie-security-inspector analyze sample_data/example.txt \
  --json --html report.html --csv findings.csv --sarif results.sarif

# Mark as sample data (banner in HTML report)
cookie-security-inspector analyze sample_data/example.txt --sample --html report.html

# Limit file size
cookie-security-inspector analyze large.bin --max-bytes 10485760
```
