...
from cookie_security_inspector.core import TOOL_NAME, TOOL_VERSION, AnalysisConfig, analyze_har

app = typer.Typer(name=TOOL_NAME, help="Parse Set-Cookie; flag missing Secure/HttpOnly/SameSite.", no_args_is_help=True)
console = Console()
...
def analyze(har_file: Path = typer.Argument(...), json_output: bool = typer.Option(False, "--json"), sample: bool = typer.Option(False, "--sample")) -> None:
    ...
    table = Table(title="Cookie Security")
